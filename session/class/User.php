...
class User extends Database
{
        public function login()
        {
                ...
                $connection = $this->pdo->prepare("SELECT * FROM user WHERE username_user = :username");
        ...
        public function register()
        {
                ...
                if ($exist != false) {
                        ...
                        $insert = $this->pdo->prepare("INSERT into user (username_user, password_user, email_user, first_name_user, last_name_user) VALUE (:username, :password, :email, :first_name, :last_name)");
